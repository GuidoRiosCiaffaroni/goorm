...
echo "PATH=\"/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/usr/lib/jvm/jdk1.8.0_211/bin:/usr/lib/jvm/ jdk-17.0.8/db/bin:/usr/lib/jvm/ jdk-17.0.8/jre/bin\" " >> /etc$echo "J2SDKDIR=\"/usr/lib/jvm/jdk-17.0.8\"" >> /etc/environment
